...
SMART_PC_CONTROL_ID="smart-pc-control"

# Uncomment for clients that don't store any state
# SMART_PC_CONTROL_STATELESS="true"

# Replace the MAC Address below with the MAC address of the ethernet device that should receive the magic packet for wake-on-lan
